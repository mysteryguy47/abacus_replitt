...
app = FastAPI(title="Abacus Paper Generator", version="2.0.0")
...
async def generate_pdf_endpoint(
    ...
    # Generate PDF
    try:
        pdf_buffer = generate_pdf(config, final_blocks, with_answers, answers_only)
        if answers_only:
...
async def download_paper_pdf(
    ...
    # Generate PDF
    try:
        pdf_buffer = generate_pdf(config, generated_blocks, with_answers)
